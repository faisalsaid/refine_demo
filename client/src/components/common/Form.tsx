        ...
        <form style={{ marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }} onSubmit={handleSubmit(onFinishHandler)}>
          ...
          <FormControl>
            ...
            <TextareaAutosize
              ...
              color="info"
              style={{ width: '100%', background: 'transparent', fontSize: '1rem', borderColor: 'rgba(0,0,0,0.23)', borderRadius: 6, padding: 10, color: '#919191' }}
          ...
          <Stack direction={'row'} gap={4}>
            <FormControl sx={{ flex: 1 }}>
              ...
              <Select
                ...
                displayEmpty
                required
                inputProps={{ 'aria-label': 'Withaout label' }}
            ...
            <FormControl>
              ...
              <TextField fullWidth required id="outlined-basic" color="info" variant="outlined" {...register('price', { required: true })} type="number" />
            </FormControl>
          </Stack>
          <FormControl>
