  ...
  return (
    <Box>
      ...
      <Box mt={'20px'} display="flex" flexWrap={'wrap'} gap={4}>
        ...
        <PieChart title="Property for rent" value={550} series={[60, 40]} colors={['#475ae8', '#e4b8ef']} />
        <PieChart title="Total customer" value={5684} series={[75, 25]} colors={['#275ae8', '#c4b8ef']} />
        <PieChart title="Total for Cities" value={555} series={[75, 25]} colors={['#275ae8', '#c4b8ef']} />
      </Box>
